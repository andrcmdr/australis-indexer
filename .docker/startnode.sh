...
/usr/local/bin/borealis-indexer --home-dir /near/testnet run --creds-path "/near/nats.creds" --nats-server "$(cat /near/server)" --subject "$(cat /near/subject)" --msg-format CBOR
